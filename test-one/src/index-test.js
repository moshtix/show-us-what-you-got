...
"Boss" when it's a multiple of 3 and "Hog" when it's a multiple of 5 all the way to 100`, async () => {
...
test(`should return the number when it is not a multiple of 3 or `, () => {
  let num = main(89);
  expect(num).toEqual(89);
});

test(`should return "Boss" when the number is a multiple of 3`, () => {
  let num = main(33);
  expect(num).toEqual("Boss");
});

test(`should return "Hog" when the number is a multiple of 5`, () => {
  let num = main(50);
  expect(num).toEqual("Hog");
});

test(`should return "BossHog" when the number is a multiple of 3 and 5`, () => {
  let num = main(75);
  expect(num).toEqual("BossHog");
});
